...
/** This is an auto generated class representing the Post1 type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "Post1s")
public final class Post1 implements Model {
  ...
  private Post1(String id, String title, PostStatus status, Integer rating, String content) {
    this.id = id;
    this.title = title;
    this.status = status;
    this.rating = rating;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), post1.getId()) &&
              ObjectsCompat.equals(getTitle(), post1.getTitle()) &&
              ObjectsCompat.equals(getStatus(), post1.getStatus()) &&
              ObjectsCompat.equals(getRating(), post1.getRating()) &&
              ObjectsCompat.equals(getContent(), post1.getContent());
      }
  }
   ...
   */
  public static Post1 justId(String id) {
    try {
