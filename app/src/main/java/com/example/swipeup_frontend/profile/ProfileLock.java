 ...
 * Use the {@link ProfileLock#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProfileLock extends Fragment {
     ...
     * @return A new instance of fragment ProfileLock.
     */
    // TODO: Rename and change types and number of parameters
    public static ProfileLock newInstance(String param1, String param2) {
        ProfileLock fragment = new ProfileLock();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_profile_lock, container, false);

        recyclerView = view.findViewById(R.id.videorecyclerView_profile_lock);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = getActivity().findViewById(R.id.videorecyclerView_profile_lock);
        recyclerView.setHasFixedSize(true);
...
//        adapters = new BookMarkSounds_adpater(getActivity(),userList);
    ...
    private void fetchUserss(String id) {
        Call<profileVideoRow> call = new RetrofitClient().getInstance().getApi().userVideosLock(id);
