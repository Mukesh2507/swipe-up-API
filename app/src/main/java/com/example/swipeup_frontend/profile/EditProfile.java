       ...
       // System.out.println(img);
        ...
        profile_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                System.out.println("mukesh profile image");
...
//        System.out.println(email);
        ticks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // String profile_img1  = img;
                System.out.println("printing profile image here ............");
             //   System.out.println(profile_img1);

   img= selectedImage.toString();
                System.out.println("imgggggggggggggggggggggggg"+img);
...
//                                editor.putString("img_url", check1.getImgurl());
                              ...
                              //  editor.putString("profile_image",profile_img1);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null) {
            if (data.getData() != null) {
                ...
                System.out.println("print selected image chamamamamammam"+selectedImage);
            }
        }
