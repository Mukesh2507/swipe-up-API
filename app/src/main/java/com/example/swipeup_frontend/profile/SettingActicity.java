...
import com.example.swipeup_frontend.HelpCenter;
import com.example.swipeup_frontend.ManageAccount;
import com.example.swipeup_frontend.R;
import com.example.swipeup_frontend.login.Sign_in_Activity;
import com.example.swipeup_frontend.Inbox.Notification.SettingsNotification;
...
//                sharedPrefManager.logout();
        ...
        Safety.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(), com.example.swipeup_frontend.Safety.class);
                startActivity(intent);
            }
        });
