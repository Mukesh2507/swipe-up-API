...
import com.example.swipeup_frontend.videos.VideosAdapter;
...
//                Intent intent = new Intent(getContext(),Foryou.class);
...
//                    System.out.println(userList);
                    adapter = new VideosAdapter(getContext(),getLayoutInflater(),videoList);
