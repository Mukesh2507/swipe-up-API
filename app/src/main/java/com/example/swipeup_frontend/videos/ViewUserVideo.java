...
import com.example.swipeup_frontend.profile.profileVideoAdapter;
 ...
 * Use the {@link ViewUserVideo#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ViewUserVideo extends Fragment {
     ...
     * @return A new instance of fragment ViewUserVideo.
     */
    // TODO: Rename and change types and number of parameters
    public static ViewUserVideo newInstance(String param1, String param2) {
        ViewUserVideo fragment = new ViewUserVideo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_view_user_video, container, false);

        recyclerView = view.findViewById(R.id.videorecyclerView_UserVideo);
...
//        recyclerView.setAdapter(adapter);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = getActivity().findViewById(R.id.videorecyclerView_UserVideo);
        recyclerView.setHasFixedSize(true);
...
//        adapters = new BookMarkSounds_adpater(getActivity(),userList);
    ...
    private void fetchUserss(String data) {
        ...
        Call<profileVideoRow> call = new RetrofitClient().getInstance().getApi().userVideosView(data);
