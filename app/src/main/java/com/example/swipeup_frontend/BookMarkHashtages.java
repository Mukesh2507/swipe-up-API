 ...
 * Use the {@link BookMarkHashtages#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BookMarkHashtages extends Fragment {
    ...
    BookMarkHashtages_adpater adapters;
     ...
     * @return A new instance of fragment BookMarkHashtages.
     */
    // TODO: Rename and change types and number of parameters
    public static BookMarkHashtages newInstance(String param1, String param2) {
        BookMarkHashtages fragment = new BookMarkHashtages();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_book_mark_hashtages, container, false);
        recyclerView = view.findViewById(R.id.bookmark_hashtag);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = getActivity().findViewById(R.id.bookmark_hashtag);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        adapters = new BookMarkHashtages_adpater(getActivity(),userList);
    ...
    private void fetchUserss(String id) {
        System.out.println(id);
        System.out.println("***");
        Call<hashtag_model> call = new RetrofitClient().getInstance().getApi().bookmarkHashtags(id);
...
//                    String resp = response.body().getResponse();
                    ...
                    System.out.println(userList);
//                    System.out.println(userList);
                    adapters = new BookMarkHashtages_adpater(getContext(),userList);
